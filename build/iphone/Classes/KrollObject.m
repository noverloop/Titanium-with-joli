...
//@interface comcouchcontrolmodel1Object : NSObject
//@end

@interface comcouchcontrolmodel1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[comcouchcontrolmodel1Object class]])
		{
			for (NSString *key in [[(comcouchcontrolmodel1Object*)o modules] allKeys])
			{
