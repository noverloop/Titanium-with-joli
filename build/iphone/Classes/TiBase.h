...
// in simulator we redefine to format for comcouchcontrolmodel1 Developer console
...
{\
	NSString * exceptionName = [@"org.comcouchcontrolmodel1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.comcouchcontrolmodel1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcomcouchcontrolmodel1NativeItemNone = -1, 
	UIcomcouchcontrolmodel1NativeItemSpinner = -2,
	UIcomcouchcontrolmodel1NativeItemProgressBar = -3,
	
	UIcomcouchcontrolmodel1NativeItemSlider = -4,
	UIcomcouchcontrolmodel1NativeItemSwitch = -5,
	UIcomcouchcontrolmodel1NativeItemMultiButton = -6,
	UIcomcouchcontrolmodel1NativeItemSegmented = -7,
	
	UIcomcouchcontrolmodel1NativeItemTextView = -8,
	UIcomcouchcontrolmodel1NativeItemTextField = -9,
	UIcomcouchcontrolmodel1NativeItemSearchBar = -10,
	
	UIcomcouchcontrolmodel1NativeItemPicker = -11,
	UIcomcouchcontrolmodel1NativeItemDatePicker = -12,
	
	UIcomcouchcontrolmodel1NativeItemInfoLight = -13,
	UIcomcouchcontrolmodel1NativeItemInfoDark = -14,
	
	UIcomcouchcontrolmodel1NativeItemDisclosure = -15,
	
	UIcomcouchcontrolmodel1NativeItemContactAdd = -16
};
